...
export const checkNetworkType = (enableProvider, provider) =>
  requestAction(CHECK_NETWORK_TYPE, { provider, enableProvider });
...
export const checkAccountChanged = (selectedAddress) => requestAction(CHECK_ACCOUNT_CHANGED, { selectedAddress });
