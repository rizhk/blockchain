...
export const ProgressSteps: FC = (props: { progressTitle: any; progressStages: any; activeStep: any }) => {
    ...
    <>
      <Box sx={{ ml: '100px', mb: '25px', mt: '25px' }}>
        ...
        <Stepper orientation="vertical" sx={{ marginBottom: '10px' }} activeStep={activeStep}>
          {progressStages.map((step: { label: {} | null | undefined; icon_status: string | number }) => (
            <Step key={step.label}>
              <StepLabel StepIconComponent={progressStateIcon[step.status]}>
                <Grid container>
