...
const CircleIconGreen: FC = (props) => (
    <Box sx={{ marginLeft: 0.25, marginTop: 0.5 }}><CircleIcon color="success" fontSize="small" /></Box>
)
const CircleIconGrey: FC = (props) => (
    <Box sx={{ marginLeft: 0.25, marginTop: 0.5 }}><CircleIcon color="disabled" fontSize="small" /></Box>
)
            ...
            step == 1 && (
                <Fade in={step == 1} timeout={1000}>
                    <Box padding={5} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', background: 'linear-gradient(180deg, rgba(13, 0, 255, 0.062) 0%, rgba(0, 0, 0, 0) 100%), #FFFFFF;', textAlign: 'center', height: '550px'}}>
                        ...
                        <Button sx={{ marginTop: 3 }} variant="contained" color="info" onClick={() => setStep(2)}>Continue</Button>
                    </Box>
                </Fade>
            )
        }
            ...
            step == 2 && (
                <Fade in={step == 2} timeout={1000}>
                    <Box padding={5} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', background: 'linear-gradient(180deg, rgba(13, 0, 255, 0.062) 0%, rgba(0, 0, 0, 0) 100%), #FFFFFF;', textAlign: 'center', height: '550px'}}>
                        ...
                        <Box>
                            <Button sx={{ marginTop: 3, marginRight: 1 }} variant="outlined" color="info" onClick={() => setStep(1)}>Go Back</Button>
                            <Button sx={{ marginTop: 3, marginLeft: 1 }} variant="contained" color="info" onClick={() => setStep(3)}>Continue</Button>
                        </Box>
                    </Box>
                </Fade>
            )
            ...
            step == 3 && (
                <Fade in={step == 3} timeout={1000}>
                    <Box padding={5} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', background: 'linear-gradient(180deg, rgba(13, 0, 255, 0.062) 0%, rgba(0, 0, 0, 0) 100%), #FFFFFF;', textAlign: 'center', height: '550px'}}>
                        ...
                        <Box>
                            <Button sx={{ marginTop: 3, marginRight: 1 }} variant="outlined" color="info" onClick={() => setStep(2)}>Go Back</Button>
                            <Button sx={{ marginTop: 3, marginLeft: 1 }} variant="contained" color="info" onClick={() => setStep(4)}>Continue</Button>
                        </Box>
                    </Box>
                </Fade>
            )
            ...
            step == 4 && (
                <Fade in={step == 4} timeout={1000}>
                    <Box padding={5} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', background: 'linear-gradient(180deg, rgba(13, 0, 255, 0.062) 0%, rgba(0, 0, 0, 0) 100%), #FFFFFF;', textAlign: 'center', height: '550px'}}>
                        ...
                        <Box>
                            <Button sx={{ marginTop: 3, marginRight: 1 }} variant="outlined" color="info" onClick={() => setStep(3)}>Go Back</Button>
                            <Button sx={{ marginTop: 3, marginLeft: 1 }} variant="contained" color="info" onClick={() => onClose(step)}>Finish</Button>
                        </Box>
                    </Box>
                </Fade>
            )
