					...
					<Fade in={step == 1} timeout={1000}>
						<Box
							...
							<Typography variant="h6">
								Welcome to Picante, let’s get started.
							</Typography>
							<Typography pt={2}>
								With Picante, your business now has a complete
								suite of tools to work directly with crypto.
								Start in the dashbaord to buy or sell your
								crypto.
							</Typography>
				...
				{step == 2 && (
					<Fade in={step == 2} timeout={1000}>
						<Box
							...
							<Typography variant="h6">
								Active matching of buyer and seller
							</Typography>
							<Typography pt={2}>
								Once you order to buy or sell crypto is placed,
								Picante immediatley matches you with a
								counterparty from its liquidity pool to fill the
								order
							</Typography>
						...
						<Box
							...
							<Box
								...
								<Stepper
									...
									<Step>
										<StepLabel
											StepIconComponent={CircleIconGrey}>
									...
									<Step>
										<StepLabel
											StepIconComponent={() => (
												<img src="/static/home/welcome_3.gif" />
											)}>
											<Typography variant="body2">
												Seller found
											</Typography>
									...
									<Step>
										<StepLabel
											StepIconComponent={CircleIconGreen}>
											<Typography variant="body2">
												Buy request subitted
											</Typography>
										</StepLabel>
									</Step>
								</Stepper>
							...
							<Typography pt={2}>
								Once an order is placed and executed, you can
								track the progress of each transaction on the
								dashboard. We will also email you once orders
								have been filled.
							</Typography>
				...
				{step == 4 && (
					<Fade in={step == 4} timeout={1000}>
						<Box
							...
							<Typography variant="h6">
								Manage payees and connect bank accounts
							</Typography>
							<Typography pt={2}>
								Easily manage payee wallets and connected bank
								accounts to quickly buy and sell your crypto.
							</Typography>
