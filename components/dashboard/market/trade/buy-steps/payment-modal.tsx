...
const TradePaymentModal = (
  ...
  const { open, ready } = usePlaidLink({
    ...
    onLoad: () => {
      console.log('WhenPlaid Link loading, the linkToken is: ' + linkToken);
    },
    env: 'sandbox',
  });
            ...
            >
              ...
              >
                ...
                <Typography align="center" color="textSecondary" sx={{ mt: 2, mb: 2 }} variant="body2">
                  We have found a seller of USDC to complete your order. Click on the button below to pay for your USDC.
                </Typography>
                <Box sx={{ m: 3 }}>
                  <LazyLoadImage
                    width="70"
                ...
                <Button size="large" variant="contained" onClick={() => open()} disabled={!ready}>
                  Pay now to complete transaction
                </Button>
                <Typography align="center" color="neutral.500" sx={{ mt: 3 }} variant="body2">
                  <span>payment secured by&nbsp;</span>
                  <LazyLoadImage src={process.env.NEXT_PUBLIC_URL + 'static/trade/plaid-logo.svg'} alt="Plaid" />
                </Typography>
