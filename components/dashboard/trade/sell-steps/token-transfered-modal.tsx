            ...
            >
              ...
              >
                ...
                <Typography align="center" color="textSecondary" sx={{ mt: 1 }} variant="body2">
                  You will receive an email when a buyer has made a bank transfer. See details of your order in the
                  transactions section.
                </Typography>
                <Box sx={{ mt: 3 }}>
                  <Button size="large" variant="contained" onClick={() => Router.push('/dashboard/transactions')}>
                    Close
                  </Button>
                </Box>
              </Paper>
